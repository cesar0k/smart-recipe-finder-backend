...
class RecipeTags(Base):
    """LLM-generated structured tags for a recipe (1:1).

    All fields nullable — NULL = not yet classified; search treats NULL as
    "include" so untagged recipes don't get hidden.
    """
    ...
    # Classification — Postgres ENUMs (see _base/enums.py). cultural_sub_region
    # stays free-text because its values are open-ended.
    ...
    # Allergens (multi-value, kept as ARRAY for simplicity)
